...
(def-doom-theme doom-rose-pine
  ...
  :family 'doom-rose-pine
  :background-mode 'dark

  ;; Main theme colors
  (
    ;; name        default   256       16
    (base           '("#191724" "#1c1c1c" "black"       ))
    (surface        '("#1f1d2e" "#262626" "black"       ))
    (overlay        '("#26233a" "#303030" "brightblack" ))
    ...
    (rose           '("#ebbcba" "#d7afaf" "magenta"     ))
    (pine           '("#31748f" "#5f8787" "brightblue"  ))
    (foam           '("#9ccfd8" "#afd7d7" "brightcyan"  ))
    (iris           '("#c4a7e7" "#d7afd7" "brightmagenta"))
    (highlightL     '("#21202e" "#262626" "brightblack" ))
    (highlightM     '("#403d52" "#444444" "brightblack" ))
    (highlightH     '("#524f67" "#585858" "brightblack" ))

    ;; Variables required by doom theme
    ;; These are required by doom theme and used in various places
    (bg             base)
    (fg             (if doom-rose-pine-brighter-text (doom-lighten text 0.2) text))
    ;; These are off-color variants of bg/fg, used primarily for `solaire-mode',
    ;; but can also be useful as a basis for subtle highlights (e.g. for hl-line
    ;; or region), especially when paired with the `doom-darken', `doom-lighten',
    ;; and `doom-blend' helper functions.
    (bg-alt         surface)
    (fg-alt         (if doom-rose-pine-brighter-text (doom-lighten text 0.2) text))
